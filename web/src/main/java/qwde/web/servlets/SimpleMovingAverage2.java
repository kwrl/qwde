...
@Controller(value = "/sma2", produces = MediaType.APPLICATION_JSON)
public final class SimpleMovingAverage2 {
    private static final Logger LOG = LoggerFactory.getLogger(SimpleMovingAverage2.class);
