...
@Controller(value = "/bb2", produces = MediaType.APPLICATION_JSON)
public final class BollingerBrand2 {
    private static final Logger LOG = LoggerFactory.getLogger(BollingerBrand2.class);
